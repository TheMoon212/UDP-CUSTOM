...
echo -e "UDP SERVICE BY CYBERVPN" | lolcat
echo -e "${GREEN}proses instalasi sedang berjalan..!!"
sleep 1
clear
echo -e "${GREEN} MENDOWNLOAD ASET..!!!"
wget -q -O /usr/bin/addudp "https://raw.githubusercontent.com/TheMoon212/Pandora/main/Ssh%20udp%20menu/addssh.sh"
wget -q -O /usr/bin/udp "https://raw.githubusercontent.com/TheMoon212/Pandora/main/Ssh%20udp%20menu/menush.sh"
